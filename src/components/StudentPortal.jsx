...
<h4>ID:19077</h4>
      ...
      <div className = "sections"><a href = "#myCourses" >My Courses</a> <a href = "#myActivities">My Activites</a>  <a href = "#personalInfo">Personal Info</a></div>
      <div className="MyCourses" id = "myCourses">
        <div class="container">
          <div class="card">
            <div class="box">
              <div class="content">
          ...
          <div class="card" style = {{position:"absolute", top:"1000px"}}>
            <div class="box">
              <div class="content">
...
<div className = "myActivitiesCards" >
 <div className = "cardsMovement"  >  
...
<svg width="71px" height="76px" viewBox="29 14 71 76" version="1.1" xmlns="http://www.w3.org/2000/svg" >
  ...
  <p>Arts</p>
  <span class = "add orange">
    <AddBoxIcon className = "formatOne" />
    <FormatListBulletedIcon className = "formatTwo" />
  </span>
